...
# Basemap "PROJ_LIB" error fix
# https://github.com/matplotlib/basemap/issues/419#issuecomment-458238218
conda_file_dir = conda.__file__
conda_dir = conda_file_dir.split('lib')[0]
os.environ["PROJ_LIB"] = os.path.join(conda_dir, os.path.join("pkgs", os.path.join("proj4-5.2.0-ha925a31_1",
                                                                                   os.path.join("Library", "share"))))
